...
def main():
    ...
    cd_kwargs = dict(
        ...
        # Ablation flags
        ablation_no_csrm=getattr(args, 'ablation_no_csrm', False),
        ablation_no_hr=getattr(args, 'ablation_no_hr', False),
        ablation_no_sem=getattr(args, 'ablation_no_sem', False),
    )

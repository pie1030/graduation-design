...
class Blip2VicunaMask(Blip2VicunaInstruct):
    ...
    def __init__(
        ...
        fusion_size=56,
        # Ablation flags
        ablation_no_csrm=False,
        ablation_no_hr=False,
        ablation_no_sem=False,
    ):
        ...
        if enable_mask_branch:
            ...
            if mask_decoder_type == "delta_cd":
                self.mask_decoder = DeltaCD(
                    ...
                    ablation_no_csrm=ablation_no_csrm,
                    ablation_no_hr=ablation_no_hr,
...
def build_model(cfg):
    ...
    model = Blip2VicunaMask(
        ...
        ablation_no_csrm=cfg.get("ablation_no_csrm", False),
        ablation_no_hr=cfg.get("ablation_no_hr", False),
        ablation_no_sem=cfg.get("ablation_no_sem", False),
    )

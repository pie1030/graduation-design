...
class Blip2OPT(Blip2Base):
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "pretrain_opt2.7b": "blip2_pretrain_opt2.7b.yaml",
    ...
    def __init__(
        ...
        opt_model = r'/root/autodl-tmp/opt-2.7b'
    ...
    def forward(self, samples):
        ...
        atts_opt = torch.ones(inputs_opt.size()[:-1], dtype=torch.long).to(imageA.device)
        ...
        empty_targets = (
            torch.ones(atts_opt.size(), dtype=torch.long).to(imageA.device).fill_(-100)
        )
        ...
        # print(atts_opt.shape)  [32, 32]
        # print(opt_tokens.attention_mask.shape) [32, x]

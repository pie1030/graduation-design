...
from benchmark import eval_metrics
...
class RunnerBase:
    ...
    def stop_criteria(self):
        return self.config.run_cfg.stop_criteria
    ...
    def setup_output_dir(self):
        lib_root = Path(os.path.dirname(os.path.abspath(__file__)))
    ...
    def train(self):
        ...
        for cur_epoch in range(self.start_epoch, self.max_epoch):
            if epochs_since_improvement == self.stop_criteria:
                print("the model has not improved in the last {} epochs".format(self.stop_criteria))
                break
            # training phase
                ...
                for split_name in self.valid_splits:
                    ...
                    if val_log is not None:
                        if is_main_process():
                            ...
                            if is_best and split_name == "val":
                                best_epoch, best_bleu4 = cur_epoch, recent_bleu4
                                if not self.evaluate_only:
    ...
    def eval_epoch(self, split_name, cur_epoch, skip_reload=False):
        ...
        # """
        # 增加
        metrics = eval_metrics(split_name, results)
